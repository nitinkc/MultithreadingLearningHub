# Blog Post Links Integration

All content in this Java Multithreading Hub is connected to the comprehensive blog series at **[nitinkc.github.io/java/multithreading/concurrency/](https://nitinkc.github.io/java/multithreading/concurrency/)**.
...
### Series Overview
- **[Series Overview](https://nitinkc.github.io/java/multithreading/concurrency/series-overview/)** — Complete roadmap of all 13 blog posts

---

## 🎓 Theory Modules → Blog Posts

Each theory module links to its corresponding blog post for deeper exploration:
...
Each lab section corresponds to theory and blog posts:
...
1. **Theory Section** → Click "📚 Read the Original Blog Post" link at the bottom of each theory page
2. **Labs Overview** → See "Lab-to-Blog Mapping" table
3. **README** → See "Blog Series Reference" section with all links
4. **Homepage** → Blog series overview section

### From Blog → This Hub

Visit **[java-multithreading-hub](../index.md)** on the blog's blog post sidebar (when visiting a blog post)

---

## 📋 Blog Post Filenames

For reference, the blog post filenames are:

```
2026-04-01-series-overview.md
2026-04-02-01-theory-and-fundamentals.md
2026-04-02-02-thread-creation-methods.md
2026-04-02-03-thread-control-coordination.md
2026-04-02-04-race-conditions-critical-sections.md
2026-04-02-05-synchronization-mechanisms.md
2026-04-02-06-locks-and-advanced-sync.md
2026-04-02-07-executor-framework.md
2026-04-02-08-completable-future-mastery.md
2026-04-02-09-concurrent-collections.md
2026-04-02-10-virtual-threads.md
2026-04-02-11-structured-concurrency-scoped-values.md
2026-04-02-12-best-practices-patterns.md
```

Located at: `/Users/sgovinda/Learn/nitinkc.github.io/_posts/java/threads/`
...
1. **Start with the hub**: Read theory sections for focused, structured learning
2. **Dive deeper**: Click blog post links for additional examples and context
3. **Practice with labs**: Complete labs to reinforce concepts
4. **Review on blog**: Reference blog posts during interview prep

### For Cross-Referencing

- Hub sections are *summaries*; blog posts contain *detailed explanations*
- Blog posts have *additional real-world examples*; hub sections are *conceptually organized*
- Use both together for **complete understanding**

### For Updates

- Hub theory sections are updated based on blog posts
- Blog posts are the primary source of truth
- Check blog series periodically for new topics or clarifications

---

## ✨ Integration Highlights

- ✅ All 15 theory modules link to corresponding blog posts
- ✅ All 9 labs link to their theory sections and blog posts
- ✅ README includes complete blog series reference
- ✅ Homepage mentions blog series overview
- ✅ Labs overview includes lab-to-blog mapping table
- ✅ Every theory section ends with blog post link

---

## 🔄 Feedback & Updates

If you find discrepancies between the hub and blog posts:
1. Check blog post (source of truth)
2. Note the discrepancy
3. Hub will be updated to align

**Blog repository**: [nitinkc/nitinkc.github.io](https://github.com/nitinkc/nitinkc.github.io)

---

## 📞 Support

- **Hub questions?** → Review theory section + linked blog post
- **Blog questions?** → Visit blog site directly
- **Lab help?** → Check theory section + blog post + lab comments
